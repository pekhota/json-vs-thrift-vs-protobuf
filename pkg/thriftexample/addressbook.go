...
func (p PhoneType) String() string {
  switch p {
  case PhoneType_MOBILE: return "MOBILE"
  case PhoneType_HOME: return "HOME"
  case PhoneType_WORK: return "WORK"
  }
  return "<UNSET>"
}
...
func PhoneTypeFromString(s string) (PhoneType, error) {
  switch s {
  case "MOBILE": return PhoneType_MOBILE, nil 
  case "HOME": return PhoneType_HOME, nil 
  case "WORK": return PhoneType_WORK, nil 
  }
...
type Person struct {
  ...
  LastUpdated *thrifttimestamp.Timestamp `thrift:"last_updated,5" db:"last_updated" json:"last_updated"`
}
...
var Person_LastUpdated_DEFAULT *thrifttimestamp.Timestamp
func (p *Person) GetLastUpdated() *thrifttimestamp.Timestamp {
...
func (p *Person)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  p.LastUpdated = &thrifttimestamp.Timestamp{}
...
func (p *Person) Equals(other *Person) bool {
  ...
  if !p.LastUpdated.Equals(other.LastUpdated) { return false }
  return true
}
...
func (p *AddressBook) Equals(other *AddressBook) bool {
  ...
  if len(p.People) != len(other.People) { return false }
